...
export declare class Client {
    ...
    deletePublisher(publisherId: number): Promise<true>;
    declareConsumer(params: DeclareConsumerParams, handle: ConsumerFunc): Promise<Consumer>;
    closeConsumer(consumerId: number): Promise<true>;
    declareSuperStreamConsumer({ superStream }: DeclareSuperStreamConsumerParams, handle: ConsumerFunc): Promise<SuperStreamConsumer>;
