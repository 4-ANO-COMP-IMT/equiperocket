...
exports.create = exports.connect = exports.errorMessageOf = exports.Connection = void 0;
...
class Connection {
    constructor(params, logger) {
        this.params = params;
        this.logger = logger;
        this.correlationId = 100;
        this.receivedResponses = [];
        this.waitingResponses = [];
        this.compressions = new Map();
        this.peerProperties = {};
        this.frameMax = util_2.DEFAULT_FRAME_MAX;
        this.serverEndpoint = { host: "", port: 5552 };
        ...
        if (params.ssl) {
            this.socket = node_tls_1.default.connect(params.port, params.hostname, { ...params.ssl, rejectUnauthorized: false });
        }
        else {
        ...
        if (params.socketTimeout)
            this.socket.setTimeout(params.socketTimeout);
        ...
        this.connectionId = (0, crypto_1.randomUUID)();
    ...
    start() {
        ...
        return new Promise((res, rej) => {
            this.socket.on("error", (err) => {
                this.logger.warn(`Error on client ${this.params.hostname}:${this.params.port} vhost:${this.params.vhost} err: ${err}`);
                return rej(err);
            });
            ...
            this.socket.on("close", (had_error) => {
                ...
                if (this.connectionClosedListener)
    ...
    async exchangeCommandVersions() {
        ...
        (0, versions_1.checkServerDeclaredVersions)(this.serverVersions, this.logger, this.peerProperties.version);
        return response;
    }
    sendAndWait(cmd) {
        return new Promise((res, rej) => {
