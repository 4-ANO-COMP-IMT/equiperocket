...
const heartbeat_request_1 = require("./requests/heartbeat_request");
class Heartbeat {
    constructor(connection, logger) {
        this.connection = connection;
        this.logger = logger;
        this.MAX_HEARTBEATS_MISSED = 2;
        this.interval = 0;
    ...
    sendHeartbeat() {
        ...
        return this.connection.send(new heartbeat_request_1.HeartbeatRequest());
    }
    async idleDetection() {
        ...
        this.logger.debug(`No messages received for the last ${noMessagesReceivedFor} ms and the interval is ${this.interval}`);
        const lastMessageSent = this.lastMessageSent.getTime();
