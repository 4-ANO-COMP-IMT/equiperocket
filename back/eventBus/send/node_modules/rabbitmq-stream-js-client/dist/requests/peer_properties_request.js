...
class PeerPropertiesRequest extends abstract_request_1.AbstractRequest {
    constructor(properties = exports.PROPERTIES) {
        super();
        this.key = PeerPropertiesRequest.Key;
        this.responseKey = peer_properties_response_1.PeerPropertiesResponse.key;
        this._properties = [];
...
PeerPropertiesRequest.Key = 0x11;
PeerPropertiesRequest.Version = 1;
