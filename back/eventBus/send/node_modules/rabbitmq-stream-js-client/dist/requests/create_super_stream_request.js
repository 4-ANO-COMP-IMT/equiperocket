...
class CreateSuperStreamRequest extends abstract_request_1.AbstractRequest {
    constructor(params) {
        super();
        this.responseKey = create_super_stream_response_1.CreateSuperStreamResponse.key;
        this.key = CreateSuperStreamRequest.Key;
        this._arguments = [];
        if (params.arguments) {
...
CreateSuperStreamRequest.Key = 0x001d;
CreateSuperStreamRequest.Version = 1;
